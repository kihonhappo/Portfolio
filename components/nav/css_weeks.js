...
const css_weeks = [
    ...
    {  
        week: 'w2', 
        title: 'Week 2: CSS Selectors - Ranking',
        examples: 
            `<div id="examples" class="section-cont">
                <div class="example">
    ...
    {
        week: 'w3',
        title: 'Week 3: CSS Preprocessors',
        examples: 
            `<div id="examples" class="section-cont">
                <div class="example">
                    <h3 class="section-header h-center">W04 Individual Activity: Javascript Form Validation</h3>
    ...
    {
        week: 'w4',
        title: 'Week 4: CSS Architecture and Organization',
        examples: 
            `<div id="examples" class="section-cont">
                <div class="example">
                    <h3 class="section-header h-center">W04 Individual Activity: Javascript Form Validation</h3>
    ...
    
    {
        ...
        style_guide: 
            `<div id="examples" class="section-cont">
                <div class="example">
                    <h3 class="section-header h-center">W05 Style Guide</h3>
    ...
    },
    {
        ...
        },
        {
            ...
            `<div id="examples" class="section-cont">
                <div class="example">
                    <h3 class="section-header h-center">W04 Individual Activity: Javascript Form Validation</h3>
                    <iframe src="./pages/css/w10/index.html" class="document-viewer"></iframe>
                </div>
            </div>`
        },
        {
